...
class SalesDashboard {
    ...
    updateUserStats(stats) {
        document.getElementById('user-total-paid').textContent = `$${stats.totalPaid.toFixed(2)}`;
        document.getElementById('user-sales-count').textContent = stats.salesCount;
        document.getElementById('user-total-unpaid').textContent = `$${stats.totalUnpaid.toFixed(2)}`;
    ...
    updateAdminStats(stats, totalRevenue) {
        ...
        document.getElementById('admin-total-paid').textContent = `$${stats.totalPaid.toFixed(2)}`;
        document.getElementById('admin-sales-count').textContent = stats.salesCount;
        document.getElementById('admin-total-unpaid').textContent = `$${stats.totalUnpaid.toFixed(2)}`;
                ...
                <div class="sale-main">
                    <div class="sale-info">
                        ...
                        <div class="sale-details">
                            Qty: ${sale.quantity} • Price: $${sale.price.toFixed(2)} • 
        ...
        salesList.innerHTML = data.sales.map(sale => `
            <div class="modal-sale-item">
                ...
                <div class="modal-sale-right">
                    <p><strong>$${(sale.quantity * sale.price).toFixed(2)}</strong></p>
